<p align="center">
  <img src="../assets/pocketrisu-banner-1024.png" alt="Kei-Risu — 自托管 AI 角色扮演聊天平台" width="900" />
</p>

<h1 align="center">Kei-Risu — 自托管 AI 角色扮演聊天</h1>
...
Kei-Risu 是一个自托管的 AI 角色扮演聊天平台,您可以在自己的 PC 或个人服务器上运行,并通过网页浏览器从 PC、平板和智能手机访问。
...
Kei-Risu 派生自 [RisuAI](https://github.com/kwaroran/RisuAI),针对自托管环境进行了改进。现有的 RisuAI 数据可以完整迁移,所有 RisuAI 生态资源都可以原样使用。
...
- 错误报告/功能请求:[GitHub Issues](https://github.com/tegy1117/Kei-Risu/issues)
