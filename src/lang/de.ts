...
export const languageGerman = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "Dies kann ein CORS-Fehler sein. Dies geschieht nur bei Verwendung der Webversion aufgrund von Browserbeschränkungen. Versuchen Sie, die lokale Desktop-Version oder eine andere Version von Kei-Risu zu verwenden.",
    ...
    "setup": {
        ...
        "welcome": "Willkommen bei Kei-Risu! Ich bin Airisu und werde Sie durch die Einrichtung von Kei-Risu führen. Zuerst, wie darf ich Sie nennen?",
    ...
    "officialWikiDesc": "Offizielles Wiki für Kei-Risu. Schauen Sie doch gerne bei uns vorbei",
    "officialDiscord": "Offizieller Discord",
    "officialDiscordDesc": "Offizieller Discord zum Austausch über Kei-Risu",
    "persona": "Mein Profil",
    "icon": "Symbol",
    "account": "Konto",
    "remove": "Entfernen",
    ...
    "risupresetDesc": "Risupreset-Format ist ein Format, das speziell für Kei-Risu-Voreinstellungen entwickelt wurde.",
    "risuMDesc": "RisuM-Format ist ein Format, das speziell für Kei-Risu-Module entwickelt wurde.",
    ...
    "pluginVersionWarn": "Dies ist Version {{plugin_version}} des Plugins, die nicht mit dieser Version von Kei-Risu kompatibel ist. Bitte aktualisieren Sie das Plugin auf Version {{required_version}}.",
    ...
    "pluginRiskDetectedAlert": "Kei-Risu hat Code erkannt, der schädlich sein könnte und IHREN API-SCHLÜSSEL ODER PERSÖNLICHE DATEN STEHLEN KANN. Wir empfehlen Ihnen, DIESES PLUGIN NICHT ZU INSTALLIEREN.",
    "doNotInstall": "Nicht installieren",
    "continueAnyway": "Trotzdem fortfahren",
    "pluginNoRiskButAlert": "Kei-Risu hat keinen schädlichen Code erkannt, aber beachten Sie bitte, dass die Installation von Plugins aus nicht vertrauenswürdigen Quellen Sicherheitsrisiken bergen kann.",
