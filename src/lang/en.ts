...
export const languageEnglish = {
    ...
    agentInfo: "Prior Agent Responses",
    agentInfoDescription: "Responses selected in Agent Presets are inserted at this exact position. Only agents from earlier stages can be connected.",
    agent: {
        menu: "Agent Presets",
        preset: "Agent Preset",
        newPreset: "New Agent Preset",
        duplicate: "Duplicate",
        delete: "Delete",
        stage: "Stage",
        addStage: "Add Stage",
        ...
        maxParallel: "Maximum parallel requests",
        promptPreset: "Prompt Preset",
        modelPreset: "Model Preset",
        promptParams: "Use prompt-preset parameters",
        postPlacement: "Output placement",
        prepend: "Above main output",
        append: "Below main output",
        replace: "Replace main output",
        noEffect: "No effect (tools only)",
        includeHistory: "Include this change in the next request",
        binding: "Agent pipeline",
        unbound: "No agent pipeline",
        setDefault: "Use for new chats",
        ...
        noConnections: "No prior responses are connected.",
        removeConnection: "Remove connection",
        insertionPoint: "Insertion point",
        noInfoCards: "Add a Prior Agent Responses item to this prompt preset, then select which earlier agents feed it.",
    ...
    errors: {
        ...
        networkFetchWeb:
            "This can be a CORS error. this only happens when using web version due to limitations of the browser. try using desktop local version, or other version of Kei-Risu.",
    ...
    setup: {
        ...
        welcome: "Welcome to Kei-Risu! I am Airisu, I am here guide you to setup Kei-Risu. First, What may I call you?",
    ...
    customCSSWarning: "Kei-Risu's UI structure (HTML/CSS) differs from upstream RisuAI, so existing custom CSS may break the layout or behave unexpectedly. Use only when you know what you are overriding.",
    customHTMLWarning: "Kei-Risu's UI structure (HTML/CSS) differs from upstream RisuAI, so existing custom Chat HTML may not render correctly. Use only when you know what you are overriding.",
    ...
    officialWikiDesc: "Official Wiki for Kei-Risu. feel free to see.",
    officialDiscord: "Official Discord",
    officialDiscordDesc: "Official Discord to talk about Kei-Risu",
    persona: "Persona",
    icon: "Icon",
    account: "Account",
    remove: "Remove",
    ...
    toolLists: "Lists",
    toolModules: "Modules & display",
    toolPlugin: "Plugin",
    toolExecution: "Function execution",
    toolExecutionScript: "Plugin script",
    toolExecutionAgent: "Sub-agent",
    toolAgentModel: "Model preset",
    toolAgentSystemPrompt: "Sub-agent system prompt",
    toolAgentUserPrompt: "Sub-agent user prompt",
    toolAgentAllowedTools: "Tools available to the sub-agent",
    toolAgentAddExternal: "Add an external tool name",
    toolAgentOutputRoutes: "Output routes (first match wins)",
    toolAgentRouteHint: "Use JavaScript regular expressions and named capture groups. Unmatched raw output is rejected and never forwarded to the main model.",
    toolAgentModelResult: "Result sent to the main model",
    toolAgentCardTemplate: "Visible call card",
    toolAgentStateActions: "Atomic state updates",
    toolPresentation: "Tool call presentation",
    toolShowInChat: "Show tool call in chat",
    toolShowInChatHint: "Disable this to keep tool execution and model history while hiding pending, success, and error cards from the chat.",
    toolPendingTemplate: "Pending card template",
    toolSuccessTemplate: "Success card template",
    toolErrorTemplate: "Error card template",
    toolCustomToggle: "Custom toggle module",
    toolCustomToggleHint: "Prompt text enabled with this tool according to global, character, chat, and package policy.",
    toolBackgroundEmbedding: "Background embedding",
    toolBackgroundEmbeddingHint: "Sanitized HTML/CSS inserted while this tool is active. Use it to style tool call cards and interactions.",
    toolAssets: "Bundled assets",
    toolAssetsHint: "Self-contained in .risutool v2. Reference an asset in a card with {{tool_asset::filename}}.",
    toolRegex: "Regular expressions",
    toolFunctionRegexHint: "Choose a function first, then choose the exact tool-pipeline stage where the regex runs.",
    toolLegacyRegex: "Legacy chat regular expressions",
    toolLegacyRegexHint: "Older module-style tool regex scripts remain active for compatibility. New scripts should use the function-specific editor above.",
    toolRegexEnabled: "Enabled",
    toolRegexNeedsFunction: "Add a tool function before creating a function-specific regex.",
    toolRegexFunction: "Function",
    toolRegexStage: "Application stage",
    toolRegexFlags: "Flags",
    toolRegexOrder: "Order",
    toolRegexArguments: "AI-provided argument strings",
    toolRegexAgentOutput: "Sub-agent raw output",
    toolRegexModelResult: "Result sent to the main model",
    toolRegexVisibleCall: "Sub-agent visible call card",
    toolRegexPendingCard: "Pending card",
    toolRegexSuccessCard: "Success card",
    toolRegexErrorCard: "Error card",
    toolTriggers: "Trigger scripts",
    toolDiceCoin: "Coin",
    toolDiceRoulette: "Roulette",
    toolDiceRoll: "Roll",
    toolDiceCancel: "Cancel roll",
    toolNamespace: "Namespace",
    toolVersion: "Version",
    toolScope: "Scope",
    toolDefaultValue: "Default value",
    toolDefaultItems: "Default items (JSON)",
    toolItemType: "Item type",
    toolParameters: "Parameters",
    toolRequired: "Required",
    toolEnabled: "Enabled",
    toolImport: "Import tool",
    toolExport: "Export tool",
    toolExportWithData: "Export with current data",
    toolClone: "Clone tool",
    toolReadonly: "Bundled tools are read-only. Clone one to edit its code.",
    toolPromptPolicy: "Tool policy",
    toolPolicyInherit: "Inherit",
    toolPolicyOn: "On",
    toolPolicyOff: "Off",
    toolPermissions: "Requested permissions",
    toolPermissionAskUser: "Ask the user",
    toolPermissionNetwork: "Network access",
    toolPermissionDatabase: "Full database access",
    toolPermissionInteractiveUi: "Interactive Tool App UI",
    toolPermissionInvokeTools: "Invoke models and other tools",
    toolPermissionCharacterRead: "Read current character",
    toolPermissionCharacterWrite: "Change current character",
    toolPermissionChatRead: "Read current chat",
    toolPermissionChatWrite: "Change current chat",
    toolPermissionLorebookRead: "Read active lorebooks",
    toolPermissionLorebookWrite: "Change character or chat lorebooks",
    toolPermissionHint: "Permissions are requested on first use and remembered for the current plugin code only.",
    toolPermissionRequest: "Tool {name} requests permission: {permission}. Allow it?",
    toolImportConfirm: "Import tool {name}?\n\nNamespace: {namespace}\nPermissions: {permissions}\nIncludes state: {state}",
    ...
    toolManualIncludeHistory: "Include manual result in model history",
    toolStateManager: "Manage state",
    toolStateGlobal: "Global",
    toolStateCharacter: "Character",
    toolStateChat: "Chat",
    toolStateUnknownCharacter: "Unknown character",
    toolStateUnknownChat: "Unknown chat",
    toolStateMemories: "Memories",
    toolStateRaw: "Raw JSON",
    toolStateRawHint: "Advanced: edit the complete state for this scope. Invalid structures are rejected when saving.",
    toolStateNoContext: "There is no current or stored context for this scope.",
    toolStateNoVariables: "This tool has no variables in this scope.",
    toolStateNoLists: "This tool has no lists in this scope.",
    toolStateNoMemories: "No memories are stored in this scope.",
    toolStateAddMemory: "Add memory",
    toolStateMemoryTitle: "Memory title",
    toolStateMemoryContent: "Memory content",
    toolStateMemoryTags: "Tags separated by commas",
    toolStateResetValue: "Reset to default",
    toolStateResetScope: "Reset this scope",
    toolStateResetConfirm: "Delete all tool state in the selected scope? This cannot be undone.",
    toolStateResetDone: "Tool state was reset.",
    toolStateDiscardConfirm: "Discard unsaved tool state changes?",
    toolStateSaved: "Tool state was saved.",
    toolStateSave: "Save state",
    toolStateInvalidNumber: "{name} must be a valid number.",
    toolStateListArray: "{name} must be a JSON array.",
    toolStateInvalidRoot: "Tool state must contain variables and lists objects, with an optional memories array.",
    chatToolsInfo: "Enable or disable tools for this chat. Right-click or long-press to bind one to the character.",
    ...
    risupresetDesc: "Risupreset format is a format specifically designed for Kei-Risu presets.",
    risuMDesc: "RisuM format is a format that is specifically designed for Kei-Risu modules.",
    ...
    pluginVersionWarn:
        "This is {{plugin_version}} version of the plugin. which is not compatible with this version of Kei-Risu. please update the plugin to {{required_version}} version.",
    ...
    modelModeLockPresetDesc: "Use Kei-Risu's model preset binding system",
    ...
    pluginRiskDetectedAlert: "Kei-Risu detected code that may be harmful which can STOLE YOUR API KEY OR PERSONAL DATA. we recommend you to NOT INSTALL THIS PLUGIN.",
    doNotInstall: "Do Not Install",
    continueAnyway: "Continue Anyway",
    pluginNoRiskButAlert: "Kei-Risu did not detect harmful code, but please be aware that installing plugins from untrusted sources can pose security risks.",
    ...
    serverBackupHeader: "Kei-Risu Server Backup",
    serverBackupDesc: "Save and restore backup files directly on the device (server) where Kei-Risu is installed, without downloading.",
    ...
    importSaveFolderHeader: "Load Save into Kei-Risu",
    ...
    remoteAccessDesc: "Use a remote access link to connect to this Kei-Risu server from another device.",
    ...
    storageDiskRisuTotal: (size: number) => `Kei-Risu total: ${(size / 1024 / 1024).toFixed(1)} MB`,
    ...
    storageInternalOnlyHint: "Off shows only Kei-Risu items; on includes system & free space relative to the disk.",
    ...
    relatedFeedbackForm: "Issues & Feedback",
