...
export const languageEnglish = {
    ...
    toolPluginApi: "Available API: registerFunction, askUser, getVariable/setVariable/resetVariable, getList/setList, memoryList/memorySearch/memoryRead/memoryUpsert/memoryDelete, nativeFetch, databaseGet/databaseSet.",
