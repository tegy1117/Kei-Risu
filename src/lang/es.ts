...
export const languageSpanish = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "Esto puede ser un error de CORS. Esto solo ocurre al usar la versión web debido a las limitaciones del navegador. Intenta usar la versión local de escritorio u otra versión de Kei-Risu.",
    ...
    "setup": {
        ...
        "welcome": "¡Bienvenido a Kei-Risu! Aquí te guiaré para configurarlo. Primero, ¿cómo puedo llamarte?",
    ...
    "officialWikiDesc": "Wiki Oficial de Kei-Risu. siéntete libre de consultarla.",
    "officialDiscord": "Discord Oficial",
    "officialDiscordDesc": "Discord Oficial para hablar sobre Kei-Risu",
    "persona": "Persona",
    "icon": "Icono",
    "account": "Cuenta",
    "remove": "Eliminar",
    ...
    "risupresetDesc": "El formato Risupreset es un formato específicamente diseñado para presets de Kei-Risu.",
    "risuMDesc": "El formato RisuM es un formato diseñado específicamente para módulos de Kei-Risu.",
    ...
    "pluginVersionWarn": "Esta es la versión {{plugin_version}} del plugin, que no es compatible con esta versión de Kei-Risu. Por favor, actualiza el plugin a la versión {{required_version}}.",
    ...
    "pluginRiskDetectedAlert": "Kei-Risu detectó código que puede ser dañino y que podría ROBAR TU CLAVE API O DATOS PERSONALES. te recomendamos NO INSTALAR ESTE PLUGIN.",
    "doNotInstall": "No Instalar",
    "continueAnyway": "Continuar de Todos Modos",
    "pluginNoRiskButAlert": "Kei-Risu no detectó código dañino, pero ten en cuenta que instalar plugins de fuentes no confiables puede plantear riesgos de seguridad.",
