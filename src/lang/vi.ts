...
export const languageVietnamese = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "This can be a CORS error. this only happens when using web version dude to limitations of the browser. try using desktop local version, or other version of Kei-Risu.",
    ...
    "setup": {
        ...
        "welcome": "Chào mừng đến với Kei-Risu! Tôi là Airisu, tôi ở đây để hướng dẫn bạn cài đặt Kei-Risu. Trước tiên, tôi có thể gọi bạn là gì?",
    ...
    "officialWikiDesc": "Wiki chính thức của Kei-Risu. cứ thoải mái xem nhé.",
    "officialDiscord": "Bất hòa chính thức",
    "officialDiscordDesc": "Discord chính thức nói về Kei-Risu",
    "persona": "nhân cách",
    "icon": "Biểu tượng",
    "account": "Tài khoản",
    "remove": "Di dời",
    ...
    "risupresetDesc": "Định dạng Risupreset là định dạng được thiết kế dành riêng cho các cài đặt trước Kei-Risu.",
    "risuMDesc": "Định dạng RisuM là định dạng được thiết kế dành riêng cho các mô-đun Kei-Risu.",
    ...
    "pluginVersionWarn": "Đây là phiên bản {{plugin_version}} của plugin, không tương thích với phiên bản Kei-Risu này. Vui lòng cập nhật plugin lên phiên bản {{required_version}}.",
    ...
    "pluginRiskDetectedAlert": "Kei-Risu phát hiện mã có thể gây hại, có thể ĂN CẮP KHÓA API HOẶC DỮ LIỆU CÁ NHÂN CỦA BẠN. Chúng tôi khuyên bạn KHÔNG NÊN CÀI ĐẶT PLUGIN NÀY.",
    "doNotInstall": "Không cài đặt",
    "continueAnyway": "Vẫn tiếp tục",
    "pluginNoRiskButAlert": "Kei-Risu không phát hiện mã độc hại, nhưng xin lưu ý rằng việc cài đặt plugin từ các nguồn không tin cậy có thể gây rủi ro bảo mật.",
