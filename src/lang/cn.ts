...
export const languageChinese = {
    ...
    "pluginVersionWarn": "这是插件的 {{plugin_version}} 版本。它与此版本的 Kei-Risu 不兼容。请将插件更新到 {{required_version}} 版本。",
    ...
    "pluginRiskDetectedAlert": "Kei-Risu 检测到可能有害的代码，这可能会窃取您的 API 密钥或个人数据。我们建议您不要安装此插件。",
    "doNotInstall": "不要安装",
    "continueAnyway": "仍然继续",
    "pluginNoRiskButAlert": "Kei-Risu 没有检测到有害代码，但请注意，从不受信任的来源安装插件可能会带来安全风险。",
