...
export const languageKorean = {
  ...
  agentInfo: "선행 에이전트 응답",
  agentInfoDescription: "에이전트 프리셋에서 선택한 선행 응답이 이 위치에 삽입됩니다. 이전 단계의 에이전트만 연결할 수 있습니다.",
  agent: {
    menu: "에이전트 프리셋",
    preset: "에이전트 프리셋",
    newPreset: "새 에이전트 프리셋",
    duplicate: "복제",
    delete: "삭제",
    stage: "단계",
    addStage: "단계 추가",
    addAgent: "에이전트 추가",
    mainOutput: "메인 출력",
    maxParallel: "최대 동시 요청 수",
    promptPreset: "프롬프트 프리셋",
    modelPreset: "모델 프리셋",
    promptParams: "프롬프트 프리셋 파라미터 사용",
    postPlacement: "출력 배치",
    prepend: "메인 출력 상단",
    append: "메인 출력 하단",
    replace: "메인 출력 대체",
    noEffect: "아무 영향 없음 (툴 전용)",
    includeHistory: "다음 전송에 이 수정 포함",
    binding: "에이전트 파이프라인",
    unbound: "에이전트 파이프라인 없음",
    setDefault: "새 채팅 기본값으로 사용",
    ...
    noConnections: "연결된 선행 응답이 없습니다.",
    removeConnection: "연결 삭제",
    insertionPoint: "삽입 위치",
    noInfoCards: "이 프롬프트 프리셋에 선행 에이전트 응답 항목을 추가한 뒤, 연결할 이전 단계 에이전트를 선택하세요.",
  ...
  toolModules: "모듈 및 표시",
  toolPlugin: "플러그인",
  toolExecution: "기능 실행 방식",
  toolExecutionScript: "플러그인 스크립트",
  toolExecutionAgent: "서브에이전트",
  toolAgentModel: "모델 프리셋",
  toolAgentSystemPrompt: "서브에이전트 시스템 프롬프트",
  toolAgentUserPrompt: "서브에이전트 사용자 프롬프트",
  toolAgentAllowedTools: "서브에이전트가 사용할 수 있는 툴",
  toolAgentAddExternal: "외부 툴 이름 추가",
  toolAgentOutputRoutes: "출력 라우트 (첫 일치 우선)",
  toolAgentRouteHint: "JavaScript 정규식과 이름 있는 캡처 그룹을 사용합니다. 어느 라우트에도 맞지 않는 원본 출력은 거부되며 메인 모델에 전달되지 않습니다.",
  toolAgentModelResult: "메인 모델에 전달할 결과",
  toolAgentCardTemplate: "사용자에게 보일 호출 카드",
  toolAgentStateActions: "원자적 상태 업데이트",
  toolPresentation: "툴 호출 표시",
  toolShowInChat: "채팅에 툴 호출 표시",
  toolShowInChatHint: "끄면 툴 실행과 모델 히스토리는 유지하면서 채팅의 대기·성공·오류 카드를 숨깁니다.",
  toolPendingTemplate: "대기 카드 템플릿",
  toolSuccessTemplate: "성공 카드 템플릿",
  toolErrorTemplate: "오류 카드 템플릿",
  toolCustomToggle: "커스텀 토글 모듈",
  toolCustomToggleHint: "글로벌·캐릭터·채팅·패키지 정책에 따라 이 툴이 활성화되면 프롬프트에 포함됩니다.",
  toolBackgroundEmbedding: "백그라운드 임베딩",
  toolBackgroundEmbeddingHint: "툴이 활성화된 동안 삽입되는 정제된 HTML/CSS입니다. 툴 호출 카드와 상호작용을 꾸밀 수 있습니다.",
  toolAssets: "포함 에셋",
  toolAssetsHint: ".risutool v2 파일에 자체 포함됩니다. 카드에서는 {{tool_asset::파일명}}으로 참조하세요.",
  toolRegex: "정규식",
  toolFunctionRegexHint: "기능을 먼저 선택한 뒤 정규식이 실행될 툴 파이프라인 단계를 선택합니다.",
  toolLegacyRegex: "레거시 채팅 정규식",
  toolLegacyRegexHint: "기존 모듈 방식의 툴 정규식은 호환성을 위해 계속 작동합니다. 새 규칙은 위의 기능별 편집기를 사용하세요.",
  toolRegexEnabled: "사용",
  toolRegexNeedsFunction: "기능별 정규식을 만들기 전에 툴 기능을 추가하세요.",
  toolRegexFunction: "기능",
  toolRegexStage: "적용 시점",
  toolRegexFlags: "플래그",
  toolRegexOrder: "순서",
  toolRegexArguments: "AI가 제공한 인자 문자열",
  toolRegexAgentOutput: "서브에이전트 원본 출력",
  toolRegexModelResult: "메인 모델에 전달할 결과",
  toolRegexVisibleCall: "서브에이전트 사용자 표시 카드",
  toolRegexPendingCard: "대기 카드",
  toolRegexSuccessCard: "성공 카드",
  toolRegexErrorCard: "오류 카드",
  toolTriggers: "트리거 스크립트",
  toolDiceCoin: "동전",
  toolDiceRoulette: "룰렛",
  toolDiceRoll: "굴리기",
  toolDiceCancel: "주사위 취소",
  ...
  toolPermissionInteractiveUi: "대화형 Tool App UI",
  toolPermissionInvokeTools: "모델 및 다른 툴 호출",
  toolPermissionCharacterRead: "현재 캐릭터 읽기",
  toolPermissionCharacterWrite: "현재 캐릭터 변경",
  toolPermissionChatRead: "현재 채팅 읽기",
  toolPermissionChatWrite: "현재 채팅 변경",
  toolPermissionLorebookRead: "활성 로어북 읽기",
  toolPermissionLorebookWrite: "캐릭터 또는 채팅 로어북 변경",
  ...
  toolManualIncludeHistory: "수동 실행 결과를 모델 히스토리에 포함",
  toolStateManager: "상태 관리",
  toolStateGlobal: "글로벌",
  toolStateCharacter: "캐릭터",
  toolStateChat: "채팅",
  toolStateUnknownCharacter: "알 수 없는 캐릭터",
  toolStateUnknownChat: "알 수 없는 채팅",
  toolStateMemories: "메모리",
  toolStateRaw: "원본 JSON",
  toolStateRawHint: "고급 기능: 이 범위의 전체 상태를 편집합니다. 잘못된 구조는 저장할 때 거부됩니다.",
  toolStateNoContext: "이 범위에 현재 또는 저장된 대상이 없습니다.",
  toolStateNoVariables: "이 범위에 선언된 변수가 없습니다.",
  toolStateNoLists: "이 범위에 선언된 리스트가 없습니다.",
  toolStateNoMemories: "이 범위에 저장된 메모리가 없습니다.",
  toolStateAddMemory: "메모리 추가",
  toolStateMemoryTitle: "메모리 제목",
  toolStateMemoryContent: "메모리 내용",
  toolStateMemoryTags: "쉼표로 구분한 태그",
  toolStateResetValue: "기본값으로 초기화",
  toolStateResetScope: "이 범위 초기화",
  toolStateResetConfirm: "선택한 범위의 모든 툴 상태를 삭제하시겠습니까? 되돌릴 수 없습니다.",
  toolStateResetDone: "툴 상태를 초기화했습니다.",
  toolStateDiscardConfirm: "저장하지 않은 툴 상태 변경을 버리시겠습니까?",
  toolStateSaved: "툴 상태를 저장했습니다.",
  toolStateSave: "상태 저장",
  toolStateInvalidNumber: "{name}은(는) 올바른 숫자여야 합니다.",
  toolStateListArray: "{name}은(는) JSON 배열이어야 합니다.",
  toolStateInvalidRoot: "툴 상태에는 variables와 lists 객체가 필요하며 memories는 배열이어야 합니다.",
