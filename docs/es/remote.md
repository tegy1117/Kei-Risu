...
Hay dos formas de acceder a Kei-Risu que se ejecuta en tu PC desde otro dispositivo (smartphone, tablet, otro PC).

- [1. Quick Tunnel](#1-quick-tunnel) — Integrado en Kei-Risu. No requiere app adicional. La URL cambia al reiniciar el servidor.
- [2. Tailscale](#2-tailscale) — Basado en red privada (VPN). URL persistente.


## 1. Quick Tunnel

Una función integrada en Kei-Risu que emite una URL temporal de acceso remoto.

1. En tu PC, en Kei-Risu: Configuración > Acceso Remoto > "Abrir Acceso Remoto"
...
En el terminal del PC que ejecuta Kei-Risu, ejecuta una vez:
